...
int main()
{
    ...
    Phone* phone1 = new Phone("Apple", "12 Pro 128 Gb", 6.1, "+380669623181", "Black", 100, 150.5, 1000, 37);
    devices[0] = phone1;

    Phone* phone2 = new Phone("Samsung", "J1 Ace", 5.7, "+380713968469", "Black", 20, 140.5, 200, 84);
    devices[1] = phone2;

    Pad* pad1 = new Pad("Apple", "iPad 7 mini", 9.8, "+7O6783296754", "Blue", 356.45, 899, 100);
    devices[2] = pad1;

    Pad* pad2 = new Pad("Asus", "Memo Pad 7", 7.9, "+380669874532", "Green", 285, 100, 69);
    devices[3] = pad2;
